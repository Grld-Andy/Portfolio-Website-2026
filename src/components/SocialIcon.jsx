export const SOCIAL_ICON_PATHS = {
  Twitter:
    'M18.9 2H22l-6.77 7.74L23.2 22h-6.24l-4.89-6.39L6.48 22H3.36l7.24-8.28L2.8 2h6.4l4.42 5.84L18.9 2Zm-1.1 17.68h1.73L8.29 4.2H6.43L17.8 19.68Z',
  LinkedIn:
    'M5.2 3.5A2.2 2.2 0 1 1 5.2 7.9a2.2 2.2 0 0 1 0-4.4ZM3.3 9.6h3.8V21H3.3V9.6Zm6.1 0h3.6v1.56h.05c.5-.95 1.72-1.96 3.55-1.96 3.8 0 4.5 2.5 4.5 5.76V21h-3.8v-5.36c0-1.28-.02-2.92-1.78-2.92-1.78 0-2.05 1.39-2.05 2.83V21H9.4V9.6Z',
  GitHub:
...
export default function SocialIcon({ label, url }) {
  const path = SOCIAL_ICON_PATHS[label];
  if (!path) return null;
